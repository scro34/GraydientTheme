...
qx.Class.define("graydienttheme.demo.Application",
{
  ...
  members:
  {
    ...
    main: function()
    {
      ...
      var about = this.about = new graydienttheme.demo.About();
      desktop.add(about);
    ...
    {
      var separator = new graydienttheme.demo.Separator(80);
      
      var themeLabel = new qx.ui.basic.Label("Graydient").set({
        font: "title", 
    ...
    onCalculator: function(e)
    {
      ...
      {
        if (!that.calculator) {
          that.calculator = new graydienttheme.demo.Calculator();
    ...
    onColorChooser: function(e)
    {
      ...
      this.dockButtonClick(button, this.colorChooser, function()
      {
        if (!that.colorChooser) {
          that.colorChooser = new graydienttheme.demo.ColorChooser();
    ...
    onTableWindow: function(e)
    {
      ...
      {
        if (!that.tableWindow) {
          that.tableWindow = new graydienttheme.demo.TableWindow();
    ...
    onWebBrowser: function(e)
    {
      ...
      {
        if (!that.webBrowser) {
          that.webBrowser = new graydienttheme.demo.WebBrowser();
    ...
    onWidgetBrowser: function(e)
    {
      ...
      this.dockButtonClick(button, this.widgetBrowser, function()
      {
        if (!that.widgetBrowser) {
          that.widgetBrowser = new graydienttheme.demo.WidgetBrowser();
    ...
    onAudioPlayerWindow: function(e)
    {
      ...
      this.dockButtonClick(button, this.audioPlayerWindow, function()
      {
        if (!that.audioPlayerWindow) {
          that.audioPlayerWindow = new graydienttheme.demo.PlayerWindow();
    ...
    onOpenHomepage: function(e)
    {
      if (!this.homePageWindow) {
        this.homePageWindow = new graydienttheme.demo.WebBrowser();
    ...
    onOpenWikipedia: function(e)
    {
      if (!this.wikipediaWindow) {
        this.wikipediaWindow = new graydienttheme.demo.WebBrowser();
    ...
    {
      if (!this.videoWindow) {
        this.videoWindow = new graydienttheme.demo.VideoWindow();
