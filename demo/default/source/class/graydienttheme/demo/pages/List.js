 ...
 * List
 * 
 * @asset(graydienttheme/demo/people.json)
 *
 */

qx.Class.define("graydienttheme.demo.pages.List",
{
  ...
  construct: function()
  {
    ...
    this.__listUrl = qx.util.ResourceManager.getInstance().toUri("graydienttheme/demo/people.json");
