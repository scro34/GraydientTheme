 ...
 *
 *
 * @asset(graydienttheme.demo/fo_tester.swf)
 * @asset(graydienttheme.demo/blank.html)
 */

qx.Class.define("graydienttheme.demo.pages.Embed",
{
  extend: graydienttheme.demo.pages.AbstractPage,
  ...
  members:
  {
    ...
    initWidgets: function()
    {
      ...
      var flash = new qx.ui.embed.Flash("graydienttheme/demo/fo_tester.swf").set({
        scale: "noscale",
        width: 100,
        height: 200,
        variables : flashVars
      ...
      richWidget.setDecorator("group-box");
