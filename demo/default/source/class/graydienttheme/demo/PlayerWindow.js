...
qx.Class.define("graydienttheme.demo.PlayerWindow",
{
  ...
  members:
  {
    ...
    {
      this._playlistUrl = qx.util.ResourceManager.getInstance().toUri("graydienttheme/demo/playlist.json");
    ...
    {
      var volumeIcon = this._volumeIcon = new qx.ui.basic.Image("graydienttheme/demo/icon/16/nm-signal-50.png").set({enabled: false});
    ...
    _createPlaylist: function()
    {
      ...
      emptyList.add(new graydienttheme.demo.Separator(80));
    ...
    _createInfoBar: function()
    {
      ...
      var btnWikipedia = this._btnWikipedia = new qx.ui.toolbar.Button(null, "graydienttheme/demo/icon/16/wikipedia.png").set({
        enabled: false
      });
      ...
      btnWikipedia.addListener("execute", function() {
        this.fireDataEvent("openWikipedia", {
          ...
          icon: "graydienttheme/demo/icon/16/wikipedia.png"
        });
      }, this);
      
      var btnVideo = this._btnVideo = new qx.ui.toolbar.Button(null, "graydienttheme/demo/icon/16/youtube.jpg").set({
        enabled: false
      });
      ...
      btnVideo.addListener("execute", function() {
        this.fireDataEvent("openVideo", {
          ...
          icon: "graydienttheme/demo/icon/16/youtube.jpg"
        });
      }, this);
    ...
    _onChangeVolume: function(e)
    {
      ...
      var statusIcon = "graydienttheme/demo/icon/16/nm-signal-00.png";
      
      switch (true)
      {
        case volume == 100:
          statusIcon = "graydienttheme/demo/icon/16/nm-signal-100.png";
          break;
          
        case volume >=66:
          statusIcon = "graydienttheme/demo/icon/16/nm-signal-75.png";
          break;
          
        case volume >= 33:
          statusIcon = "graydienttheme/demo/icon/16/nm-signal-50.png";
          break;
          
        case volume > 0:          
          statusIcon = "graydienttheme/demo/icon/16/nm-signal-25.png";
          break;
      }
