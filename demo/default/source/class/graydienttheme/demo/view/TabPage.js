...
/**
 *
 * @asset(graydienttheme.demo/loader.gif)
 * @use(graydienttheme.demo.pages.Tree)
 * @use(graydienttheme.demo.pages.List)
 * @use(graydienttheme.demo.pages.Form)
 * @use(graydienttheme.demo.pages.ToolBar)
 * @use(graydienttheme.demo.pages.Window)
 * @use(graydienttheme.demo.pages.Tab)
 * @use(graydienttheme.demo.pages.Embed)
 * @use(graydienttheme.demo.pages.EmbedFrame)
 * @use(graydienttheme.demo.pages.Misc)
 */

qx.Class.define("graydienttheme.demo.view.TabPage",
{
  extend: qx.ui.tabview.Page,

  include: graydienttheme.demo.MControls,
  ...
  construct: function(label, classname, controls)
  {
    ...
    var inner = new graydienttheme.demo.Separator(80);
