    ...
    */
    ...
    "scrollbar/slider/knob":
    {
      style: function(states)
      {
        ...
        return {
          height: states.horizontal ? 10 : undefined,
          width: states.vertical ? 10 : undefined,
    ...
    "toolbar-button":
    {
      ...
      style: function(states)
      {
        ...
        return {
          cursor: states.disabled ? "default" : "pointer",
          decorator: decorator,
          padding: states.pressed || states.checked ? [4, 5, 2, 5] : [4, 6]
        };
      }
    },
    ...
    "window/captionbar":
    {
      style: function(states)
      {
        return {
          ...
          textColor: states.active && !states.disabled ? "text-caption" : "text-disabled",
          //~ minHeight: 30,
          padding: [3, 4, 4, 4],
          font: "bold"
        };
